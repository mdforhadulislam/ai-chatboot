...
let CustomersController = class CustomersController {
    ...
    async create(dto) {
        ...
        return (0, response_util_1.successResponse)(data, 'Customer created');
    }
    ...
    async update(id, dto) {
        ...
        return (0, response_util_1.successResponse)(data, 'Customer updated');
    }
    async remove(id) {
        await this.customersService.remove(id);
        return (0, response_util_1.successResponse)(null, 'Customer deleted');
    }
};
